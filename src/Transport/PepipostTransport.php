<?php
namespace UmairParacha00\LaravelPepipostMailer\Transport;
...
class PepipostTransport extends Transport
{
    ...
    protected const SMTP_API_NAME = 'pepipostapi';
    protected const MAXIMUM_FILE_SIZE = 20480000;
    protected const BASE_URL = 'https://api.pepipost.com/v2/sendEmail';
    ...
    private function getAttachments(Swift_Mime_SimpleMessage $message): array
    {
        ...
        foreach ($message->getChildren() as $attachment) {
            ...
            if ((!$attachment instanceof Swift_Attachment && !$attachment instanceof Swift_Image)
                ...
                || ($attachment->getBody() === '') > self::MAXIMUM_FILE_SIZE
            ) {
                continue;
            }
            $attachments[] = [
     ...
     */
    private function post($payload): Response
    {
